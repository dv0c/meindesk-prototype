  ...
  return (
    <DraggableBlockPlugin_EXPERIMENTAL
      ...
      menuComponent={
        <div
          ref={menuRef}
          className="draggable-block-menu absolute top-0 left-0 -translate-x-full cursor-grab rounded-sm px-px py-0.5 opacity-0 will-change-transform hover:bg-gray-100 active:cursor-grabbing"
        >
