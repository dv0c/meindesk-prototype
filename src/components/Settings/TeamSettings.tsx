...
import { inviteMember, removeMember, leaveTeam, getTeamMembers, revokeInvitation } from "@/lib/actions/team-actions"
                                    ...
                                    {invitations.map((invite) => (
                                        <div key={invite.id} className="flex items-center justify-between p-2 rounded-lg border border-dashed hover:bg-accent/50 transition-colors">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <Button variant="ghost" size="icon" className="h-6 w-6 text-muted-foreground hover:text-destructive" onClick={() => handleRevoke(invite.id)}>
